...
Then, we compare our model predictions with the testing data set to measure the accuracy. We observe a perfect accuracy of 1,00. This may be due to some sort of overfitting:
